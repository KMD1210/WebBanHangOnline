...
(function( $, window, document, undefined ) {
	...
	DataTable.models.oColumn = {
		...
		/**
		 * TieuDe of the column - what is seen in the TH element (nTh).
		 *  @type string
		 */
		"sTitle": null,
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			/**
			 * ChiTiet the action that will be taken when the drop down menu for the
	...
	//
	// Backwards compatibility. biDanh to pre 1.10 Hungarian notation counter parts
	//
	$.extend( _ext, {
