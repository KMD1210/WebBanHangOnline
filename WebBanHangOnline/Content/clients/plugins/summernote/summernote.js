    ...
    */
    ...
    value: function insertImagesOrCallback(files) {
      ...
      if (callbacks.onImageUpload) {
        this.context.triggerEvent('image.upload', files); // else insert HinhAnh as dataURL
      } else {
