...
namespace WebBanHangOnline.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ActionResult Add() //lấy ra danh mục sản phẩm
        {
            ViewBag.ProductCategory = new SelectList(db.ProductCategories.ToList(), "Id", "TieuDe");
            return View();
        }
